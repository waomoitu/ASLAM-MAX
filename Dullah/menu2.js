...
const {
    ...
    MENU_STATS_LINE = "│⭐ ",
    MENU_BOTTOM_DIVIDER = "└─────────────┈⳹",
    FOOTER = `\n\n©Aslam max\n\n╭━========================\n┃  ᴛᴏ sᴇᴇ ᴀʟʟ ᴄᴏᴍᴍᴀɴḍs ᴛᴏɢᴇᴛʜᴇʀ ᴜsᴇ \n┃ *${PREFIX} Cmds*\n┃ *${PREFIX} Help*\n┃ *${PREFIX} list*\n┃ *${PREFIX} Commands* \n╰━========================\n\n®2025🔥`,
    WEB = 'Aslam max',
    GURL = 'https://dullahxmd.top'
} = s;
...
// Audio files
const githubRawBaseUrl = "https://raw.githubusercontent.com/aslammax/bwm-xmd-music/master/tiktokmusic";
...
const fetchGitHubStats = async () => {
    try {
        const owner = "Aslam-max";
        const repo = "Aslam max";
        const response = await axios.get(`https://api.github.com/repos/${owner}/${repo}`, {
            headers: {
                'User-Agent': 'Aslam max'
            }
        });
...
dullah({ nomCom: "menu", categorie: "General" }, async (dest, zk, commandeOptions) => {
    ...
    let { cm } = require(__dirname + "/../Aslam/dullah");
