...
dullah({ nomCom: "join", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
// Get JID of user
dullah({ nomCom: "jid", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
// Block user
dullah({ nomCom: "block", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
// Unblock user
dullah({ nomCom: "unblock", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
// Group invite link
dullah({ nomCom: "invite", categorie: 'Group', reaction: "📩", nomFichier: __filename }, async (chatId, zk, { repondre, superUser, verifAdmin }) => {
  try {
...
// Add user to group
dullah({ nomCom: "add", categorie: 'Group', reaction: "➕", nomFichier: __filename }, async (chatId, zk, { repondre, arg, superUser, verifAdmin }) => {
  try {
    if (!superUser && !verifAdmin) {
...
// Leave group
dullah({ nomCom: "left", categorie: 'Group', reaction: "🚪", nomFichier: __filename }, async (chatId, zk, { repondre, superUser }) => {
  try {
    if (!superUser) {
...
dullah({ nomCom: "remove", categorie: 'Group', reaction: "👢", nomFichier: __filename }, async (chatId, zk, { repondre, arg, superUser, verifAdmin, msgRepondu, auteurMsgRepondu }) => {
  try {
    if (!superUser && !verifAdmin) {
      return repondre("❌ You need admin privileges to use this command");
    }
...
// Kick user from group
dullah({ nomCom: "kick", categorie: 'Group', reaction: "👢", nomFichier: __filename }, async (chatId, zk, { repondre, arg, superUser, verifAdmin, msgRepondu, auteurMsgRepondu }) => {
  try {
    if (!superUser && !verifAdmin) {
      return repondre("❌ You need admin privileges to use this command");
    }
...
dullah({ nomCom: "kickall", categorie: 'Group', reaction: "🔥", nomFichier: __filename }, async (chatId, zk, { repondre, superUser, auteurMessage }) => { 
  if (!superUser) {
    return repondre("❌ This command is reserved for the bot owner only");
  }
...
dullah({ nomCom: "tagall", categorie: 'Group', reaction: "👥", nomFichier: __filename }, async (chatId, zk, { repondre, verifAdmin, superUser }) => {
  try {
    if (!superUser && !verifAdmin) {
      return repondre("❌ You need admin privileges to use this command");
    }
...
dullah({ nomCom: "opengroup", categorie: 'Group', reaction: "🔓", nomFichier: __filename }, async (chatId, zk, { repondre, superUser }) => { 
  if (!superUser) {
    return repondre("❌ This command is reserved for the bot owner only");
  }
...
dullah({ nomCom: "closegroup", categorie: 'Group', reaction: "🔒", nomFichier: __filename }, async (chatId, zk, { repondre, superUser }) => { 
  if (!superUser) {
    return repondre("❌ This command is reserved for the bot owner only");
  }
...
dullah({ nomCom: "hidetag", categorie: 'Group', reaction: "📢", nomFichier: __filename }, async (chatId, zk, { repondre, arg, verifAdmin, superUser }) => { 
  if (!superUser && !verifAdmin) {
    return repondre("❌ You need admin privileges to use this command");
  }
...
dullah({ nomCom: "promote", categorie: 'Group', reaction: "⬆️", nomFichier: __filename }, async (chatId, zk, { repondre, arg, superUser, msgRepondu, auteurMsgRepondu }) => { 
  if (!superUser) {
    return repondre("❌ This command is reserved for the bot owner only");
  }
...
dullah({ nomCom: "demote", categorie: 'Group', reaction: "⬇️", nomFichier: __filename }, async (chatId, zk, { repondre, arg, superUser, msgRepondu, auteurMsgRepondu }) => { 
  if (!superUser) {
    return repondre("❌ This command is reserved for the bot owner only");
  }
...
dullah({ nomCom: "groupn", categorie: 'Group', reaction: "✏️", nomFichier: __filename }, async (chatId, zk, { repondre, arg, superUser }) => { 
  if (!superUser) {
    return repondre("❌ This command is reserved for the bot owner only");
  }
...
dullah({ nomCom: "groupd", categorie: 'Group', reaction: "📝", nomFichier: __filename }, async (chatId, zk, { repondre, arg, superUser }) => { 
  if (!superUser) {
    return repondre("❌ This command is reserved for the bot owner only");
  }
...
// Get group info
dullah({ nomCom: "ginfo", categorie: 'Group', reaction: "ℹ️", nomFichier: __filename }, async (chatId, zk, { repondre }) => {
  try {
    const metadata = await zk.groupMetadata(chatId);
