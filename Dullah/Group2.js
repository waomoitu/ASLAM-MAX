...
dullah({ nomCom: "opentime",categorie: "Group", reaction: "⏱️", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
...
dullah({ nomCom: "closetime", categorie: "Group",reaction: "⏱️", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
  const { repondre, arg, verifAdmin, superUser } = commandeOptions;
...
dullah({ nomCom: "canceltimer", categorie: "Group",reaction: "❌", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
...
dullah({ nomCom: "lockdown", categorie: "Group",reaction: "🚫", nomFichier: __filename }, async (chatId, zk, { repondre, verifAdmin }) => {
  try {
...
dullah({ nomCom: "tagadmin", categorie: "Group",reaction: "🛡️", nomFichier: __filename }, async (chatId, zk, { repondre, arg }) => {
  try {
...
dullah({ nomCom: "resetlink",categorie: "Group", reaction: "🔄", nomFichier: __filename }, async (chatId, zk, { repondre, verifAdmin }) => {
  try {
    if (!verifAdmin) {
...
dullah({ nomCom: "poll", categorie: "Group",reaction: "📊", nomFichier: __filename }, async (chatId, zk, { repondre, arg, verifAdmin }) => {
  try {
    if (!verifAdmin) {
...
dullah({ nomCom: "countries",categorie: "Group", reaction: "🌍", nomFichier: __filename }, async (chatId, zk, { repondre }) => {
  try {
    const metadata = await zk.groupMetadata(chatId);
...
dullah({ nomCom: "ephemeral",categorie: "Group", reaction: "⏳", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
...
dullah({ nomCom: "del", categorie: "Group",reaction: "🗑️", nomFichier: __filename }, async (dest, zk, commandeOptions) => {
...
dullah({ nomCom: "reject", categorie: "Group",reaction: "❌", nomFichier: __filename }, async (chatId, zk, { repondre, verifAdmin }) => {
  try {
    if (!verifAdmin) {
...
dullah({ nomCom: "approve", categorie: "Group",reaction: "✅", nomFichier: __filename }, async (chatId, zk, { repondre, verifAdmin }) => {
  try {
    if (!verifAdmin) {
