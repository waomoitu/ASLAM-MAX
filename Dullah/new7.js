...
dullah({
    ...
    try {
        ...
        responseText += "\n━━━━━━━━━━━━━━━━━━━━━━\n";
        responseText += "> © Aslam max Phone Tracker";
        ...
        await zk.sendMessage(dest, {
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    mediaType: 1,
                    thumbnailUrl: "https://url.bwmxmd.online/Dullah.fwzxhzl7.jpg",
                    sourceUrl: "https://url.bwmxmd.online/Dullah.fwzxhzl7.jpg",
...
dullah({
    ...
    try {
        ...
        caption += `> Aslam max QR Generator`;
...
dullah({
    ...
    try {
        ...
        response += `> Aslam max System Monitor`;
